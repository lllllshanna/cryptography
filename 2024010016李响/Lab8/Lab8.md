...
&#x20; D(k, c\_1) \& \\text{若 } D(k, c\_1) = D(k, c\_2) \\\\
...
E'((k\_1, k\_2), t, x) = E(k\_1, x) \\oplus E(k\_2, t)
...
&#x20; E'((k\_1,k\_2),t,0) \\oplus E'((k\_1,k\_2),t',1)

&#x20; =

&#x20; E'((k\_1,k\_2),t',1) \\oplus E'((k\_1,k\_2),t',0)
...
&#x20; E'((k\_1,k\_2),t,x) \\oplus E'((k\_1,k\_2),t',x)
...
&#x20; E'((k\_1,k\_2),0,x) \\oplus E'((k\_1,k\_2),1,x)
...
&#x20; E'((k\_1,k\_2),0,x) \\oplus E'((k\_1,k\_2),0,x)
...
设 $E\_{PRP}$ 是一个安全的分组密码，$P(t, i)$ 是一个公开函数（例如 $P(t, i) = E\_{PRP}(t, i)$）。考虑如下可调分组密码构造：



$$

E'\\big(k, (t, i), x\\big) = E\_{PRP}\\big(k, x \\oplus P(t, i)\\big) \\oplus P(t, i)
...
2026-06-02，届时关于 Lab8 的 PR 请求将不会被合并。
